...
package com.davidvlijmincx.generated.fcntl;
...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fcntl_h.C_LONG.withName("st_dev"),
        fcntl_h.C_LONG.withName("st_ino"),
        fcntl_h.C_LONG.withName("st_nlink"),
        fcntl_h.C_INT.withName("st_mode"),
        fcntl_h.C_INT.withName("st_uid"),
        fcntl_h.C_INT.withName("st_gid"),
        fcntl_h.C_INT.withName("__pad0"),
        fcntl_h.C_LONG.withName("st_rdev"),
        fcntl_h.C_LONG.withName("st_size"),
        fcntl_h.C_LONG.withName("st_blksize"),
        fcntl_h.C_LONG.withName("st_blocks"),
        timespec.layout().withName("st_atim"),
        timespec.layout().withName("st_mtim"),
        timespec.layout().withName("st_ctim"),
        MemoryLayout.sequenceLayout(3, fcntl_h.C_LONG).withName("__glibc_reserved")
    ).withName("stat");
