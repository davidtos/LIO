...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, fuse_h.C_POINTER).withName("__locales"),
        fuse_h.C_POINTER.withName("__ctype_b"),
        fuse_h.C_POINTER.withName("__ctype_tolower"),
        fuse_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, fuse_h.C_POINTER).withName("__names")
