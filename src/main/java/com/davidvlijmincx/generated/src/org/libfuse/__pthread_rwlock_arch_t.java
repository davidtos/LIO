...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fuse_h.C_INT.withName("__readers"),
        fuse_h.C_INT.withName("__writers"),
        fuse_h.C_INT.withName("__wrphase_futex"),
        fuse_h.C_INT.withName("__writers_futex"),
        fuse_h.C_INT.withName("__pad3"),
        fuse_h.C_INT.withName("__pad4"),
        fuse_h.C_INT.withName("__cur_writer"),
        fuse_h.C_INT.withName("__shared"),
        fuse_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, fuse_h.C_CHAR).withName("__pad1"),
        fuse_h.C_LONG.withName("__pad2"),
        fuse_h.C_INT.withName("__flags"),
