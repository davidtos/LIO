...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fuse_h.C_INT.withName("tm_sec"),
        fuse_h.C_INT.withName("tm_min"),
        fuse_h.C_INT.withName("tm_hour"),
        fuse_h.C_INT.withName("tm_mday"),
        fuse_h.C_INT.withName("tm_mon"),
        fuse_h.C_INT.withName("tm_year"),
        fuse_h.C_INT.withName("tm_wday"),
        fuse_h.C_INT.withName("tm_yday"),
        fuse_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        fuse_h.C_LONG.withName("tm_gmtoff"),
        fuse_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
