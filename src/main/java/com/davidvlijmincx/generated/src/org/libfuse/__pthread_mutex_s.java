...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fuse_h.C_INT.withName("__lock"),
        fuse_h.C_INT.withName("__count"),
        fuse_h.C_INT.withName("__owner"),
        fuse_h.C_INT.withName("__nusers"),
        fuse_h.C_INT.withName("__kind"),
        fuse_h.C_SHORT.withName("__spins"),
        fuse_h.C_SHORT.withName("__elision"),
