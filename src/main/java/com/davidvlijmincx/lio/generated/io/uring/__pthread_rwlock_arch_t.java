...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburingtest.C_INT.withName("__readers"),
        liburingtest.C_INT.withName("__writers"),
        liburingtest.C_INT.withName("__wrphase_futex"),
        liburingtest.C_INT.withName("__writers_futex"),
        liburingtest.C_INT.withName("__pad3"),
        liburingtest.C_INT.withName("__pad4"),
        liburingtest.C_INT.withName("__cur_writer"),
        liburingtest.C_INT.withName("__shared"),
        liburingtest.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, liburingtest.C_CHAR).withName("__pad1"),
        liburingtest.C_LONG.withName("__pad2"),
        liburingtest.C_INT.withName("__flags"),
