...
public class flock {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburingtest.C_SHORT.withName("l_type"),
        liburingtest.C_SHORT.withName("l_whence"),
        MemoryLayout.paddingLayout(4),
        liburingtest.C_LONG.withName("l_start"),
        liburingtest.C_LONG.withName("l_len"),
        liburingtest.C_INT.withName("l_pid"),
        MemoryLayout.paddingLayout(4)
    ).withName("flock");
