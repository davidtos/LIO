...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburingtest.C_LONG.withName("st_dev"),
        liburingtest.C_LONG.withName("st_ino"),
        liburingtest.C_LONG.withName("st_nlink"),
        liburingtest.C_INT.withName("st_mode"),
        liburingtest.C_INT.withName("st_uid"),
        liburingtest.C_INT.withName("st_gid"),
        liburingtest.C_INT.withName("__pad0"),
        liburingtest.C_LONG.withName("st_rdev"),
        liburingtest.C_LONG.withName("st_size"),
        liburingtest.C_LONG.withName("st_blksize"),
        liburingtest.C_LONG.withName("st_blocks"),
        timespec.layout().withName("st_atim"),
        timespec.layout().withName("st_mtim"),
        timespec.layout().withName("st_ctim"),
        MemoryLayout.sequenceLayout(3, liburingtest.C_LONG).withName("__glibc_reserved")
    ).withName("stat");
