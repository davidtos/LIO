...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburingtest.C_INT.withName("tm_sec"),
        liburingtest.C_INT.withName("tm_min"),
        liburingtest.C_INT.withName("tm_hour"),
        liburingtest.C_INT.withName("tm_mday"),
        liburingtest.C_INT.withName("tm_mon"),
        liburingtest.C_INT.withName("tm_year"),
        liburingtest.C_INT.withName("tm_wday"),
        liburingtest.C_INT.withName("tm_yday"),
        liburingtest.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        liburingtest.C_LONG.withName("tm_gmtoff"),
        liburingtest.C_POINTER.withName("tm_zone")
    ).withName("tm");
